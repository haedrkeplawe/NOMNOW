...
const ORDER_STATUS_TEMPLATES = {
  ...
  picked_up: (order) => ({
    // v4.10.1 — تصحيح: النص القديم "السائق استلم طلبك من المطعم" كان
    // يوهم إنو السائق فعلياً بإيده الأكل، بينما "picked_up" بالنظام
    // معناها بس "تم تعيين سائق" (ممكن يكون لسا بالطريق للمطعم). كان
    // بيتناقض مباشرة مع توضيح ميزة الوقت المتوقع لفريق الفلتر.
    title: "تم تعيين سائق لطلبك 🛵",
    body: `سائق في طريقه لاستلام طلبك رقم ${order.orderNumber}`,
  }),
  on_the_way: (order) => ({
