const translations = {
  en: {
    ...
    auth: {
      ...
      // v2.0 — ب1: كانت مفقودة بالكامل من الجذر رغم استخدامها بـ resendOtp
      invalidResendType: "Type must be either 'phone' or 'email'",
      resendTooSoon: "Please wait before requesting another OTP",
  ...
  ar: {
    auth: {
      ...
      // v2.0 — ب1
      invalidResendType: "يجب أن يكون النوع 'phone' أو 'email'",
      resendTooSoon: "يرجى الانتظار قبل طلب رمز تحقق آخر",
      resendSuccess: "تم إعادة إرسال رمز التحقق بنجاح.",
      resendFailed: "فشل إعادة إرسال رمز التحقق. يرجى المحاولة مجدداً.",
    },
    ...
    food: {
      ...
      // v2.0 — ب1
      invalidMainCategory: "القسم العام غير صالح",
    },
  ...
  de: {
    auth: {
      ...
      // v2.0 — ب1
      invalidResendType: "Typ muss entweder 'phone' oder 'email' sein",
      resendTooSoon: "Bitte warte, bevor du einen weiteren Code anforderst",
      resendSuccess: "Bestätigungscode erneut gesendet.",
      resendFailed:
        "Bestätigungscode konnte nicht erneut gesendet werden. Bitte versuche es erneut.",
    },
...
translations.ar.driver = {
  auth: {
    ...
    accountPending: "حسابك قيد المراجعة. يرجى انتظار الموافقة.",
...
translations.de.driver = {
  auth: {
    ...
    accountPending: "Dein Konto wird überprüft. Bitte warte auf die Freigabe.",
...
translations.en.socket = {
  ...
  user: {
    ...
    cartChangedSinceOrder:
      "Your cart changed after this order was created. Please review it before sending.",
  },
  restaurant: {
    orderIdRequired: "orderId is required",
...
translations.ar.socket = {
  ...
  user: {
    ...
    // v2.0 — تحصين 6
    cartChangedSinceOrder:
      "تغيّرت سلتك بعد إنشاء هذا الطلب. يرجى مراجعتها قبل الإرسال.",
  },
  restaurant: {
    orderIdRequired: "معرّف الطلب مطلوب",
...
translations.de.socket = {
  ...
  user: {
    ...
    // v2.0 — تحصين 6
    cartChangedSinceOrder:
      "Dein Warenkorb hat sich nach Erstellung dieser Bestellung geändert. Bitte überprüfe ihn vor dem Senden.",
  },
  restaurant: {
    orderIdRequired: "Bestell-ID ist erforderlich",
...
translations.en.user = {
  ...
  cart: {
    ...
    // v2.0 — ب1: applyCoupon يستخدمها ولم تكن موجودة أصلاً بهذا القسم
  ...
  order: {
    ...
    invalidDeliveryAddress:
      "A valid delivery address with location is required",
  ...
  rating: {
    ...
    // v2.0 — ب1: مُستعادة من نسخة معطَّلة سابقاً (كانت مفقودة من هون
    // فعلياً منذ ميزة تقييم السائق — راجع BACKEND_TASK_driver_rating_per_order.md)
...
translations.ar.user = {
  ...
  cart: {
    ...
    // v2.0 — تحصين 1 و5
    invalidExtra: "إضافة واحدة أو أكثر غير متاحة لهذه الوجبة",
  ...
  order: {
    ...
    restaurantClosed: "المطعم مغلق حالياً",
    // v2.0 — تحصين 2
    invalidDeliveryAddress: "عنوان توصيل صالح مع الموقع مطلوب",
  ...
  rating: {
    ...
    // v2.0 — ب1: مُستعادة (راجع ملاحظة النسخة الإنكليزية)
...
translations.de.user = {
  ...
  cart: {
    ...
    // v2.0 — تحصين 1 و5
    invalidExtra: "Ein oder mehrere ausgewählte Extras sind für diesen Artikel nicht verfügbar",
  ...
  order: {
    ...
    // v2.0 — تحصين 2
    invalidDeliveryAddress:
      "Eine gültige Lieferadresse mit Standort ist erforderlich",
...
module.exports = { getMessages, getSocketMessages };