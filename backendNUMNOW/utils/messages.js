...
translations.en.socket = {
  driver: {
    ...
    waitingConfirmation:
      "Waiting for customer confirmation — {{minutes}} minute(s) remaining",
  ...
  user: {
    ...
    alreadyConfirmed: "Order already confirmed or not found",
  },
  restaurant: {
    orderIdRequired: "orderId is required",
...
translations.ar.socket = {
  driver: {
    ...
    waitingConfirmation: "في انتظار تأكيد العميل — {{minutes}} دقيقة متبقية",
  ...
  user: {
    ...
    alreadyConfirmed: "تم تأكيد الطلب بالفعل أو غير موجود",
  },
  restaurant: {
    orderIdRequired: "معرّف الطلب مطلوب",
...
translations.de.socket = {
  driver: {
    ...
    waitingConfirmation:
      "Warten auf Kundenbestätigung — {{minutes}} Minute(n) verbleibend",
  ...
  user: {
    ...
    alreadyConfirmed: "Bestellung bereits bestätigt oder nicht gefunden",
  },
  restaurant: {
    orderIdRequired: "Bestell-ID ist erforderlich",
