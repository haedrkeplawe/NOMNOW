...
app.use("/api/user", require("./routes/user.routes")); // update
...
// Namespace لكل نوع مستخدم
const adminNS = io.of("/admin"); // للادمن
const driverNS = io.of("/driver"); // للسائقين
const restaurantNS = io.of("/restaurant"); // للمطاعم
const userNS = io.of("/user"); // للمستخدمين العاديين
