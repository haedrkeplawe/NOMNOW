...
exports.getFinancialOverview = async (req, res) => {
  try {
    const restaurantId = req.user.restaurantId;
    const SETTLEMENT_DAYS = 21;

    // جلب نسبة العمولة من موديل المطعم
    ...
    // جلب كل الأوردرات المكتملة والملغية
    ...
    res.status(200).json({
      ...
      overview: {
        ...
        availableToSettle: round(availableToSettle),
