...
exports.getFinancialTransactions = async (req, res) => {
  try {
    ...
    const formattedOrders = orders.map((o) => {
      ...
      const effectiveDeliveryFee = o.originalDeliveryFee ?? deliveryFee;
...
exports.getOrderDetails = async (req, res) => {
  try {
    ...
    const effectiveDeliveryFee = order.originalDeliveryFee ?? deliveryFee;
