...
exports.getAllRestaurant = async (req, res) => {
  try {
    ...
    let sorted;
    if (sort === "rating") {
      sorted = enriched.sort((a, b) => b._rating - a._rating || byNearest(a, b));
    } else if (sort === "popular") {
      sorted = enriched.sort((a, b) => b._popular - a._popular || byNearest(a, b));
    } else {
      sorted = enriched.sort((a, b) => byNearest(a, b) || b._rating - a._rating);
    }
...
exports.getAllFood = async (req, res) => {
  try {
    ...
    const foods = sortedFoods.map(({ _rating, _popular, _distance, ...f }) => f);
