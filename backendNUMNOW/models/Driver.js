...
const driverSchema = new mongoose.Schema(
  {
    ...
    // new
    // ── نظام الكاش (السائق السوري فقط) ───────────────────────
    // cashCreditLimit : الحد الأقصى للكاش المسموح للسائق بحمله (يضبطه الأدمن)
    // cashCollected   : إجمالي الكاش المجموع من الطلبات المسلّمة حتى الآن
    cashCreditLimit: {
      type: Number,
      default: 0,
      min: 0,
