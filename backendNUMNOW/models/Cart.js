...
const cartSchema = new mongoose.Schema(
  {
    ...
    // v3.9 — الكوبون المطبّق على السلة (اختياري، null افتراضياً)
    // نخزّن الكود بس (مش قيمة الخصم المحسوبة) لأنو الخصم لازم يُعاد
    // حسابه دايماً من قيمة الكوبون الحية + itemsPrice الحالي — هيك
    // لو الأدمن عدّل قيمة الكوبون أو تغيّرت محتويات السلة بعد التطبيق،
    // ما بيصير أي تعارض بين رقم مخزّن قديم والواقع الحالي.
    couponCode: {
      type: String,
      default: null,
    },
