...
// order
router.patch("/order/cancelfromuser", auth, userController.cancelOrderFromUser); // new
router
  .route("/order")
  .get(auth, userController.getUserOrders) // new
  .post(auth, userController.createOrder); // new
