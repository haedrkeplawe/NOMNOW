...
// update update
// هذه اصبحت تشمل تعديل كافه بيانات المركبه بما في ذلك جميع الصور الخاصه بالسائق والمركبه
// ايضا لتعديل الاسم
// ملاطظه هامه جدا عند تعديل اي شي في هذا الكنتورلر سوف يتم تحويل السائق الى حالة الانتظار مره اخرى حتى يتم مراجعة البيانات من قبل الادمن واعتمادها
// هذا الامر يطبق على كل شي عدا تعديل الاسم فقط حيث ان تعديل الاسم لا يتطلب مراجعة من الادمن  وسوف يستطيع السائق مواصله عمله بشكل طبيعي دون ان يتم تحويله الى حالة الانتظار
router.patch(
  "/update-info",
  authAllowPending,
  upload.fields([
