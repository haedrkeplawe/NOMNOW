            ...
            <div className="aord-totals">
              ...
              {order.taxBreakdown ? (
                <>
                  <div className="aord-totals__row">
                    <span>
                      Food Tax ({order.taxBreakdown.foodTaxRate}% MwSt)
                    </span>
                    <span>
                  ...
                  <div className="aord-totals__row">
                    <span>
                      Delivery Tax ({order.taxBreakdown.deliveryTaxRate}% MwSt)
                    </span>
                    <span>
...
const AdminOrders = () => {
  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      // إذا جاء restaurantId من navigation state → نفلتر بالمطعم ونتجاهل country
      ...
      const res = await api.get(
        `/admin/orders?${statusParam}&search=${dSearch}&page=${page}&limit=30${restaurantParam}`,
      );
  ...
  }, [api, activeTab, dSearch, page, countryParam, restaurantId]);
    ...
    <div className="aord-page">
      ...
      <div className="aord-header">
        <div>
          ...
          <p>
            {restaurantId
              ? `Showing orders for: ${restaurantName}`
      ...
      {restaurantId && (
        <div className="aord-filter-banner">
          <BsShop size={14} />
          <span>
            Filtered by restaurant: <strong>{restaurantName}</strong>
          </span>
          <div className="aord-filter-banner__actions">
            <button
              className="aord-filter-banner__btn"
            ...
            <button
              className="aord-filter-banner__btn aord-filter-banner__btn--back"
              onClick={() => {
                // نخزن في sessionStorage لأن Restaurants.jsx يقرأ منه عند التحميل
                sessionStorage.setItem(
                  "openRestaurantAnalytics",
