        ...
        <form onSubmit={handleSubmit}>
          <div className="inputs">
            ...
            <div className="input">
              ...
              >
                <option value="SY">🇸🇾 Syria — SYP | Cash only | Tax 0%</option>
                <option value="DE">
                  🇩🇪 Germany — EUR | All payments | VAT 19%
                </option>
              </select>
            </div>
            {/* Address Fields */}
            ...
            <div className="input">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder={
                  data.country === "DE" ? "+49XXXXXXXXXX" : "+963XXXXXXXXX"
                }
                pattern={
                  data.country === "DE"
                    ? "\\+49[1-9][0-9]{9,13}"
                ...
                title={
                  data.country === "DE"
                    ? "German number: +49XXXXXXXXXX"
                    : "Syrian number: +963XXXXXXXXX"
                }
                required
              />
            </div>
