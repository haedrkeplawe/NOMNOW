...
const Details = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // تحديث القائمة بدون إعادة جلب كل المطاعم
      ...
      // تحديث المطعم المختار
      setRestaurantChossen(updatedRestaurant);

      setType("details");
      toast.success(`Retaurant ${restaurantChossen.name} Updated Successfully`);
    } catch (error) {
              ...
              <div className="container">
                ...
                <div className="summary">
                  ...
                  <div className="revenue">
                    ...
                    <h2>22500 {restaurantChossen.currency}</h2>
