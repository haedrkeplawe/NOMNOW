...
const CreateFood = ({ category, mainCategories, setType, setFoods }) => {
  const { api } = useAuth();
  ...
  const resetForm = () => {
    ...
    setImage(null);
    setOpen(false);
    setOpenMainCategory(false); // v3.7
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("mainCategoryId", formData.mainCategoryId); // v3.7 — اختياري
      data.append(
        "ingredients",
