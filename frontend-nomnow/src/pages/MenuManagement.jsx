        ...
        <div className="view-food__body">
          ...
          <div className="view-food__section">
            <div className="view-food__row">
              ...
              {food.sizes?.length > 0 ? (
                <strong>
                  from {Math.min(...food.sizes.map((s) => s.price))} {currency}
                </strong>
              ) : (
                <strong>
                  {food.price} {currency}
          ...
          {food.sizes?.length > 0 && (
            <div className="view-food__section">
              <p className="view-food__label">Sizes</p>
          ...
          {food.ingredients?.length > 0 && (
            <div className="view-food__section">
              <p className="view-food__label">Ingredients</p>
          ...
          {food.extras?.length > 0 && (
            <div className="view-food__section">
              <p className="view-food__label">Extras</p>
