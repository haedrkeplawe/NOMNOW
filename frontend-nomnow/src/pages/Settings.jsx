...
const Settings = () => {
  ...
  const [soundEnabled, setSoundEnabled] = useState(
    () => localStorage.getItem("nomnow_sound") !== "false",
  );

  const handleSoundToggle = () => {
    const newVal = !soundEnabled;
    setSoundEnabled(newVal);
    localStorage.setItem("nomnow_sound", String(newVal));
  };
  ...
  if (loadingPage)
    return (
      <div className="setting-page page-loader">
      ...
      <div className="profile notifications-section">
        ...
        <div className="notification-item">
          <div className="notification-item__text">
            <h4>{t("settings.soundAlert")}</h4>
            <p>{t("settings.soundAlertDesc")}</p>
          </div>
          <button
            type="button"
